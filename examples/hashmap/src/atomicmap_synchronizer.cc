...
AtomicMapSynchronizer::AtomicMapSynchronizer(std::vector<std::string>* log_addr, std::vector<ColorID>& interesting_colors, bool replication): m_replication(replication) {
        uint32_t i;
        struct colors* c;
