...
def main():
	...
	if os.getenv('FUZZY_ORSET_LOC') == None:
		print 'The FUZZY_ORSET_LOC environment variable must point to the top level of the or-set example directory'
		sys.exit()

	os.chdir(os.getenv('FUZZY_ORSET_LOC'))
